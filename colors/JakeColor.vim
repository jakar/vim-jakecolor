...
call s:HL("cssClassName", s:pink, "", "")
  ...
  " Qt qmake Highlighting
  " call s:HL("qmakeComment", s:foreground, "", "")
  " call s:HL("qmakeEscapedChar", s:foreground, "", "")
  " call s:HL("qmakeQuotedString", s:foreground, "", "")
  " call s:HL("qmakeVarDecl", s:foreground, "", "")
  call s:HL("qmakeVarAssign", s:foreground, "", "")
  " call s:HL("qmakeVarValue", s:foreground, "", "")
  " call s:HL("qmakeMacroParens", s:foreground, "", "")
  call s:HL("qmakeMacroArgs", s:foreground, "", "")
  " call s:HL("qmakeMacroComma", s:foreground, "", "")
  " call s:HL("qmakeEnvValue", s:foreground, "", "")
  " call s:HL("qmakePropValue", s:foreground, "", "")
  " call s:HL("qmakeUserMacroDecl", s:foreground, "", "")
  " call s:HL("qmakeUserMacroName", s:foreground, "", "")
  " call s:HL("qmakeUserFuncDecl", s:foreground, "", "")
  " call s:HL("qmakeUserFuncName", s:foreground, "", "")
  " call s:HL("qmakeFuncReturn", s:foreground, "", "")
  call s:HL("qmakeFuncReturnArgs", s:foreground, "", "")
  " call s:HL("qmakeBuiltinVarName", s:foreground, "", "")
  call s:HL("qmakeBuiltinVarVal", s:green, "", "bold")
  call s:HL("qmakeBuiltinProp", s:navy, "", "bold")
  call s:HL("qmakeBuiltinMacro", s:aqua, "", "")
  " call s:HL("qmakeBuiltinFunc", s:foreground, "", "")
  " call s:HL("qmakeScope", s:foreground, "", "")
